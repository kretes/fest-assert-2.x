...
import static org.fest.assertions.error.ShouldBeEmpty.*;
import static org.fest.assertions.error.ShouldBeEqualIgnoringCase.*;
import static org.fest.assertions.error.ShouldBeNullOrEmpty.*;
import static org.fest.assertions.error.ShouldContainString.*;
import static org.fest.assertions.error.ShouldEndWith.*;
import static org.fest.assertions.error.ShouldHaveSameSizeAs.*;
import static org.fest.assertions.error.ShouldHaveSize.*;
import static org.fest.assertions.error.ShouldMatchPattern.*;
import static org.fest.assertions.error.ShouldNotBeEmpty.*;
import static org.fest.assertions.error.ShouldNotContainString.*;
import static org.fest.assertions.error.ShouldNotMatchPattern.*;
import static org.fest.assertions.error.ShouldStartWith.*;
...
public class Strings {
	 ...
	 *             if the given {@code String} is not {@code null} *and* it is not empty.
	 */
	 ...
	 * @throws AssertionError
	 *             if the given {@code String} is not empty.
	 */
	 ...
	 *            the given {@code String}.
	 * @param expectedSize
	 *            the expected size of {@code actual}.
	 * @throws AssertionError
	 *             if the given {@code String} is {@code null}.
	 * @throws AssertionError
	 *             if the size of the given {@code String} is different than the expected one.
	 */
	 ...
	 * @throws AssertionError
	 *             if the number of entries in the given {@code String} does not have the same size.
	 */
	 ...
	 *             if the given sequence is {@code null}.
	 * @throws AssertionError
	 *             if the given {@code String} is {@code null}.
	 * @throws AssertionError
	 *             if the actual {@code String} does not contain the given sequence.
	 */
	 ...
	 *             if the actual {@code String} does not contain the given sequence.
	 */
	public void assertContainsOnce(AssertionInfo info, String actual, String sequence) {
		checkSequenceIsNotNull(sequence);
		assertNotNull(info, actual);
		if (stringContainsOnce(actual, sequence)) {
			return;
		}
		throw failures.failure(info, shouldContainOnce(actual, sequence, comparisonStrategy));
	}

	private boolean stringContainsOnce(String actual, String sequence) {
		int firstIndexOf = actual.indexOf(sequence);
		int secondIndexOf = actual.indexOf(sequence, firstIndexOf);
		return firstIndexOf >= 0 && secondIndexOf >= 0;
	}
	 ...
	 *             if the given {@code String} is {@code null}.
	 * @throws AssertionError
	 *             if the actual {@code String} contains the given sequence.
	 */
	 ...
	 *            the actual {@code String}.
	 * @param expected
	 *            the expected {@code String}.
	 * @throws AssertionError
	 *             if the given {@code String}s are not equal.
	 */
	 ...
	 *             if the given {@code String} is {@code null}.
	 * @throws AssertionError
	 *             if the actual {@code String} does not start with the given prefix.
	 */
	 ...
	 *             if the given {@code String} is {@code null}.
	 * @throws AssertionError
	 *             if the actual {@code String} does not end with the given suffix.
	 */
	 ...
	 *            the given {@code String}.
	 * @param regex
	 *            the regular expression to which the actual {@code String} is to be matched.
	 * @throws NullPointerException
	 *             if the given pattern is {@code null}.
	 * @throws PatternSyntaxException
	 *             if the regular expression's syntax is invalid.
	 * @throws AssertionError
	 *             if the given {@code String} is {@code null}.
	 * @throws AssertionError
	 *             if the actual {@code String} does not match the given regular expression.
	 */
	 ...
	 *             if the regular expression's syntax is invalid.
	 * @throws AssertionError
	 *             if the actual {@code String} matches the given regular expression.
	 */
	 ...
	 *             if the given {@code String} is {@code null}.
	 * @throws AssertionError
	 *             if the given {@code String} does not match the given regular expression.
	 */
	 ...
	 *             if the given pattern is {@code null}.
	 * @throws AssertionError
	 *             if the given {@code String} matches the given regular expression.
	 */
